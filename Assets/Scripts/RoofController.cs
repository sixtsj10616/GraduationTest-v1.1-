...
public class RoofController : MonoBehaviour
{
	...
	public RoofType roofType = RoofType.Wu_Dian_Ding;
    ...
    public void InitFunction(BuildingObj parentObj)
    {
        //初始值******************************************************************************
        parent = parentObj;
        allJijaHeight = parent.bodyController.eaveColumnHeight * 1.2f;
        eave2eaveColumnOffset = parent.bodyController.eaveColumnHeight * 0.4f;
        eave2FlyEaveOffset = parent.bodyController.eaveColumnHeight * 0.4f;
        beamsHeight = parent.bodyController.eaveColumnHeight * 0.1f;
        roofTopCenter = parent.bodyController.bodyCenter + new Vector3(0, parent.bodyController.eaveColumnHeight / 2.0f + allJijaHeight, 0);
        Wu_Dian_DingMainRidgeWidth = parent.bodyController.eaveColumnHeight * 0.4f;
        Lu_DingMainRidgeOffset = parent.bodyController.eaveColumnHeight * 0.5f;


        //************************************************************************************
        roof = new GameObject("Roof");
        roof.transform.position = roofTopCenter;
        roof.transform.parent = parent.building.transform;
	...
	RidgeStruct CreateMainRidgeTile(MainRidgeModelStruct mainRidgeModelStructGameObject, RidgeStruct mainRidgeStruct, RoofSurfaceStruct roofSurfaceStruct, RidgeStruct eaveRidgeStruct, GameObject parent)//主脊瓦片
	{
        ...
        RidgeStruct baseList = CreateRidgeSturct("MainRidgeTileStruct", roof);
    ...
    RidgeStruct CreateMainRidgeStruct(int eaveColumnListIndex, Vector3 topControlPointPos)
	{
		...
		//DownControlPoint
		Vector3 eave2eaveColumnOffsetVector = Vector3.Normalize(new Vector3(parent.bodyController.eaveColumnList[eaveColumnListIndex].topPos.x - topControlPointPos.x, 0, parent.bodyController.eaveColumnList[eaveColumnListIndex].topPos.z - topControlPointPos.z)) * eave2eaveColumnOffset + flyEaveHeightOffset * Vector3.up;
		Vector3 downControlPointPos = parent.bodyController.eaveColumnList[eaveColumnListIndex].topPos + eave2eaveColumnOffsetVector + beamsHeight * Vector3.up;
    ...
    **/
	...
	public void CreateRoof()
	{
		...
		int ColumnIndex_Zero = (parent.bodyController.eaveColumnbayNumber > 0) ? 0 * parent.bodyController.eaveColumnbayNumber : 0;
		int ColumnIndex_One = (parent.bodyController.eaveColumnbayNumber > 0) ? 1 * parent.bodyController.eaveColumnbayNumber : 1;
		int ColumnIndex_Two = (parent.bodyController.eaveColumnbayNumber > 0) ? 2 * parent.bodyController.eaveColumnbayNumber : 2;
		switch (roofType)
		{
			//攢尖頂
			case RoofType.Zan_Jian_Ding:
				...
				if (MainController.Instance.sides == MainController.FormFactorSideType.FourSide)
				{
					...
					//複製出其他屋面
					CopyRoofFunction(roof, parent.building, 180, roofTopCenter, 2, roofTopCenter - roofTopCenter);
				...
				else
				{
					...
					//複製出其他屋面
					CopyRoofFunction(roof, parent.building, 360.0f / (int)MainController.Instance.sides, roofTopCenter, (int)MainController.Instance.sides, roofTopCenter - roofTopCenter);
			...
			case RoofType.Wu_Dian_Ding:
				...
				offsetVector = (parent.bodyController.eaveColumnList[ColumnIndex_Zero].topPos - parent.bodyController.eaveColumnList[1].topPos).normalized * Wu_Dian_DingMainRidgeWidth;
				...
				Vector2 v1 = new Vector2(rightRoofTopCenter.x - parent.bodyController.eaveColumnList[ColumnIndex_Zero].topPos.x, rightRoofTopCenter.z - parent.bodyController.eaveColumnList[ColumnIndex_Zero].topPos.z);
				Vector2 v2 = new Vector2(leftRoofTopCenter.x - parent.bodyController.eaveColumnList[ColumnIndex_One].topPos.x, leftRoofTopCenter.z - parent.bodyController.eaveColumnList[ColumnIndex_One].topPos.z);

				float angle = Vector2.Angle(v1, v2);


				CopyRoofFunction(RightMainRidgeStruct.body, parent.building, angle, rightRoofTopCenter, 2, leftRoofTopCenter - rightRoofTopCenter);
			...
			case RoofType.Lu_Ding:
				...
				if (MainController.Instance.sides == MainController.FormFactorSideType.FourSide) { 
				//主脊-MainRidge輔助線 
				offsetVector = (new Vector3(parent.bodyController.eaveColumnList[ColumnIndex_Zero].topPos.x - roofTopCenter.x, 0, parent.bodyController.eaveColumnList[ColumnIndex_Zero].topPos.z - roofTopCenter.z)).normalized * Lu_DingMainRidgeOffset;
				RightMainRidgeStruct = CreateMainRidgeStruct(ColumnIndex_Zero, roofTopCenter + offsetVector);

				offsetVector = (new Vector3(parent.bodyController.eaveColumnList[ColumnIndex_One].topPos.x - roofTopCenter.x, 0, parent.bodyController.eaveColumnList[ColumnIndex_One].topPos.z - roofTopCenter.z)).normalized * Lu_DingMainRidgeOffset;
				...
				//主脊-MainRidge輔助線 
				RightMainRidgeStructA = LeftMainRidgeStruct;
				offsetVector = (new Vector3(parent.bodyController.eaveColumnList[ColumnIndex_Two].topPos.x - roofTopCenter.x, 0, parent.bodyController.eaveColumnList[ColumnIndex_Two].topPos.z - roofTopCenter.z)).normalized * Lu_DingMainRidgeOffset;
				...
				CreateMainRidgeTile(ModelController.Instance.mainRidgeModelStruct, RightMainRidgeStructA, roofSurfaceStructListA, eaveStructA, RightMainRidgeStructA.body);
				//複製出其他屋面
				CopyRoofFunction(roof, parent.building, 360.0f / ((int)MainController.Instance.sides / 2), roofTopCenter, (int)MainController.Instance.sides / 2, roofTopCenter - roofTopCenter);
				}
				#endregion
				break;
		}
