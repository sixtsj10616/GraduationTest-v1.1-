...
public class MainController : Singleton<MainController>
{
    ...
    public List<GameObject> Buildings = new List<GameObject>();       //* 建築樓層列表
    public int selectFloor = 0;                                       //* 目前 選擇/建造 的樓層
    private int tmpFloorHeight = 26;
    //FormFactor***********************************************************************
    ...
    {
        //BuildingObj newBuilding = new BuildingObj();
        //Buildings.Add(newBuilding);
        //newBuilding.initFunction(Vector3.zero, 30, 30, 3);
        ...
        newBuilding.GetComponent<BuildingObj>().initFunction(newBuilding,Vector3.zero, 30, 30, 3);
        Buildings.Add(newBuilding);
    }
    /**
     * 新增樓層
    ...
    public void createNewFloor()
    {
        ...
        BuildingObj newBuilding = new BuildingObj();
        selectFloor++;
        Vector3 nowTopPosition = Buildings[Buildings.Count - 1].roof.roofTopCenter;
        //Buildings.Add(newBuilding);
        Buildings.Insert(selectFloor, newBuilding);
        newBuilding.initFunction(nowTopPosition,30,30,3);
        */
        selectFloor++;
        GameObject newBuilding = new GameObject("building" + Buildings.Count);
        Vector3 nowTopPosition = Buildings[selectFloor - 1].GetComponent<BuildingObj>().roofController.roofTopCenter;
        ...
        {
            GameObject building = Buildings[iIndex];
            building.transform.position = building.transform.position + tmpFloorHeight * Vector3.up;
        }
    ...
    {
        /*
        BuildingObj deleteBuilding = Buildings[floor];
        DestroyObject(deleteBuilding);
        //Destroy(deleteBuilding);
        Buildings.RemoveAt(selectFloor);
        selectFloor = floor--;
        */
        GameObject item = this.transform.GetChild(selectFloor).gameObject;
        Destroy(this.transform.GetChild(selectFloor).gameObject);
        Buildings.RemoveAt(selectFloor);
